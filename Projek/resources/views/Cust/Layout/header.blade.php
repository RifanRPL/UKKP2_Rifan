                ...
                <div class="navbar-header">
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box">
                            <a href="{{route('cust.index')}}" class="logo logo-dark">
                                <span class="logo-sm">
                            ...
                            <a href="{{route('cust.index')}}" class="logo logo-light">
                                <span class="logo-lg">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                           <li>
                            ...
                            <li class="menu-title" data-key="t-applications">Customer</li>

                            <li>
                                <a href="{{route('pengaduan.create')}}">
                                    <i class="bx bx-file icon nav-icon"></i>
                                    <span class="menu-item" data-key="t-todo">Form Pengaduan</span>
                                </a>
                            </li>
                            ...
                            <li>
                                <a href="{{route('pengaduan.index')}}">
                                    <i class="bx bx-file icon nav-icon"></i>
                                    <span class="menu-item" data-key="t-todo">List Pengaduan</span>
                                </a>
                            </li>
                                ...
                                <ul class="navbar-nav">
                                    <li class="nav-item dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="topnav-dashboard">
                                            <a href="{{route('cust.index')}}"  class="dropdown-item" data-key="t-ecommerce">Ecommerce</a>
